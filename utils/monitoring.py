...
def capture_exception(error: Exception, extra: dict[str, Any] | None = None) -> str | None:
...
def capture_message(message: str, level: str = "info", extra: dict[str, Any] | None = None) -> str | None:
...
def add_breadcrumb(message: str, category: str = "default", level: str = "info", data: dict[str, Any] | None = None) -> None:
